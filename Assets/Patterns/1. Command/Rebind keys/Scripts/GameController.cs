...
namespace CommandPattern.RebindKeys
{
    ...
    public class GameController : MonoBehaviour
    {
        ...
        public ExpandObject objectThatExpands;
        ...
        void Start()
        {
            ...
            buttonO = new ExpandCube(objectThatExpands);
        ...
        void Update()
        {
            ...
            {
                ExecuteNewCommand(buttonO);
            }
            else if (Input.GetKeyDown(KeyCode.P))
            {
                ExecuteNewCommand(buttonP);
            }
